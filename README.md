...
*   **Reinicio Mensual**: Función "Iniciar Nuevo Mes" que:
    *   Elimina ingresos extra pasados.
    *   Desmarca gastos pagados (para el nuevo mes).
    *   Mantiene tus ahorros intactos.
    *   Genera un reporte de cierre de mes.
...
*   `lib/`: Código fuente de la aplicación (Dart).
    ...
    *   `screens/`: Pantallas de la app (`HomeScreen`, `SavingsScreen`, etc.).
